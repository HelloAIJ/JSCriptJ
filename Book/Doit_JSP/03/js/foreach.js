// 105P
document.write('const students = ["Park", "Kim", "Lee", "Kang"];<br>'
...
// const beforeStudentsArr = students.slice(0, 3);
// const lastStudentsArr = students.slice(3);
// document.write(`${beforeStudentsArr}, `);
// document.write(`${lastStudentsArr}.`);
// 화살표 함수를 사용한다면
